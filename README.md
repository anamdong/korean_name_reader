...
- `data/bongwan_geography.json`
- `data/peninsula_regions.geojson`
- `.nojekyll`
...
The Bon-gwan Map Explorer uses the local province/equivalent map and conservative
historical-place mapping documented in `data/BONGWAN_MAP_SOURCES.md`. It is a
thematic exploration tool, not an ancestry prediction or historical-boundary map.
